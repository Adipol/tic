                                   ...
                                   <tbody class="buscar">
                                       <?php 
                                        ...
                                        $dat="  SELECT
												...
												FROM
												internet
												INNER JOIN bus ON internet.bus_idbus = bus.idbus
												INNER JOIN instalacion ON internet.instalacion_idinstalacion = instalacion.idinstalacion
												INNER JOIN usuario ON internet.usuario_idusuario = usuario.idusuario
												WHERE $dato3 ='$dato'
												ORDER BY 
												idbus ASC";
										$da=mysql_query($dat);
