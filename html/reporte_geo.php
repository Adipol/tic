            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Sistema de Geolocalización</h4> </div>
                </div>
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                               ...
                               <table class="table table-striped  table-condensed text-center"  >
                                   ...
                                   <tbody class="buscar">
                                        ...
                                        $dat="  SELECT
												...
												FROM
												geolocalizacion
												INNER JOIN bus ON geolocalizacion.bus_idbus = bus.idbus
												INNER JOIN instalacion ON geolocalizacion.instalacion_idinstalacion = instalacion.idinstalacion
												INNER JOIN usuario ON geolocalizacion.usuario_idusuario = usuario.idusuario
                                                WHERE $dato3='$dato'
