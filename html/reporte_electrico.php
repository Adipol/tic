            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Sistema Electrico</h4> </div>
                </div>
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                                    ...
                                    <tbody class="buscar">
                                       <?php 
                                        ...
                                        $dat="  SELECT
												...
												FROM
												electrico
												INNER JOIN bus ON electrico.bus_idbus = bus.idbus
												INNER JOIN instalacion ON electrico.instalacion_idinstalacion = instalacion.idinstalacion
												INNER JOIN usuario ON electrico.usuario_idusuario = usuario.idusuario
												WHERE $dato3='$dato'
												ORDER BY
												bus.idbus ASC";
